(function () {
    const buttons = Array.from(document.querySelectorAll('.licensing-language-button'));
    ...
    function setLanguage(language) {
        ...
        document.title = isFrench
            ? 'Licences d’art numérique - Gianni Perugini'
            : 'Digital Art Licensing - Gianni Perugini';
